...
describe('HttpService', () => {
  ...
  describe('post', () => {
    it('should post to the correct url', waitForAsync(() => {
      ...
      // act
      const result$ = service.post<unknown>(url, body);
  ...
  describe('put', () => {
    it('should put to the correct url', waitForAsync(() => {
      service.put<unknown>('some-url', { any: 'thing' }).subscribe((data) => {
  ...
  describe('patch', () => {
    it('should patch to the correct url', waitForAsync(() => {
      service.patch<unknown>('some-url', { any: 'thing' }).subscribe((data) => {
        expect(data).toEqual({ any: 'thing' });
  ...
  describe('delete', () => {
    it('should delete to the correct url', waitForAsync(() => {
      service.delete<unknown>('some-url').subscribe(() => {
  ...
  describe('get', () => {
    it("has not headers if url is not 'apiIntegration'", waitForAsync(() => {
      ...
      service.get<{ firstName: string }>(url).subscribe((data) => {
